<x-layout>
    ...
    <x-card>
        ...
        enctype="multipart/form-data">
            @csrf
            <div class="mb-4">
                <label for="expected_salary" class="mb-2 block w-full text-sm font-medium text-slate-900">
                    Expected Salary
                </label>
            ...
            <div class="mb-4">
                <label class="mb-2 block w-full text-sm font-medium text-slate-900">Upload CV</label>
